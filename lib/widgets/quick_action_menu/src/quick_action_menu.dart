        ...
        IgnorePointer(
          ...
          child: AnimatedOpacity(
            ...
            child: GestureDetector(
              onTap: _close,
              child: Container(color: AppColors.fontColor.withValues(alpha: 0.5)),
            ),
          ),
        ),
        ...widget.actions.map(
          (action) => QuickActionButton(action, isOpen: _isOpen, index: widget.actions.indexOf(action), close: _close),
        ),
        Padding(
